...
class ModelClient:
    ...
    def __init__(self) -> None:
        ...
        self.require_models = os.getenv("OPENAI_REQUIRE_MODELS", "true").lower() not in {"0", "false", "no"}

        self.api_key = os.getenv("OPENAI_API_KEY")
        self.text_model = os.getenv("OPENAI_TEXT_MODEL", "gpt-5.5")
        self.vision_model = os.getenv("OPENAI_VISION_MODEL", self.text_model)
